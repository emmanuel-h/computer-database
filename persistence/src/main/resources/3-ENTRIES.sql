...
insert into user_role(User_username,roles_role) values('admin','USER');

insert into company (id,name,number_of_computers,image_url) values (  1,'Apple Inc.',38,'https://upload.wikimedia.org/wikipedia/commons/thumb/f/fa/Apple_logo_black.svg/1200px-Apple_logo_black.svg.png');
insert into company (id,name,number_of_computers,image_url) values (  2,'Thinking Machines',6,'http://cdn.campaignbrief.com/asia/assets_c/2013/08/TTM%20NEW%20LOGO-thumb-200x233-123211.jpg');
insert into company (id,name,number_of_computers,image_url) values (  3,'RCA',2,'https://londonjazzcollector.files.wordpress.com/2013/02/rca_records_logo-svg.png');
insert into company (id,name,number_of_computers,image_url) values (  4,'Netronics',1,'http://mitc-ae.net/images/clients/netronics.png');
insert into company (id,name,number_of_computers,image_url) values (  5,'Tandy Corporation',4,'https://www.kennedycreeklime.com.au/wp-content/uploads/2014/10/TANDY-GROUP-191x191.png');
insert into company (id,name,number_of_computers,image_url) values (  6,'Commodore International',24,'https://upload.wikimedia.org/wikipedia/commons/thumb/5/5c/CBM_Logo.svg/1200px-CBM_Logo.svg.png');
insert into company (id,name,number_of_computers,image_url) values (  7,'MOS Technology',1,'https://www.microsoft.com/en-us/CMSImages/lrn_com-mos-active.png?version=de746832-9bbb-9294-b9ab-2d28e4f7ff33');
insert into company (id,name,number_of_computers,image_url) values (  8,'Micro Instrumentation and Telemetry Systems',1,'https://upload.wikimedia.org/wikipedia/commons/a/ac/No_image_available.svg');
insert into company (id,name,number_of_computers,image_url) values (  9,'IMS Associates, Inc.',1,'https://xanatek.com/wp-content/uploads/2017/04/ims-logo.png');
insert into company (id,name,number_of_computers,image_url) values ( 10,'Digital Equipment Corporation',27,'https://files.startupranking.com/startup/thumb/48364_24fafb7cd20f511aa3fe834ba5f353aff1cbef02_digital-equipment-corporation-dec_l.png');
insert into company (id,name,number_of_computers,image_url) values ( 11,'Lincoln Laboratory',0,'https://fruitfuldreams.files.wordpress.com/2014/06/mitlincolnlaboratory.png');
insert into company (id,name,number_of_computers,image_url) values ( 12,'Moore School of Electrical Engineering',0,'http://brucesparforthecause.com/wp-content/uploads/2016/05/moore-engineering-company.3-266x266.png');
insert into company (id,name,number_of_computers,image_url) values ( 13,'IBM',20,'http://logok.org/wp-content/uploads/2014/06/IBM-logo-black.png');
insert into company (id,name,number_of_computers,image_url) values ( 14,'Amiga Corporation',1,'https://www.a1200.net/wp-content/uploads/2016/05/AmigaInc_Squared.png');
insert into company (id,name,number_of_computers,image_url) values ( 15,'Canon',1,'http://logok.org/wp-content/uploads/2015/01/Canon-logo-wordmark-880x660.png');
insert into company (id,name,number_of_computers,image_url) values ( 16,'Nokia',4,'https://www.nokia.com/sites/default/files/media/nokia_white_logo.png');
insert into company (id,name,number_of_computers,image_url) values ( 17,'Sony',6,'https://seeklogo.com/images/S/Sony-logo-BD927CA2CA-seeklogo.com.png');
insert into company (id,name,number_of_computers,image_url) values ( 18,'OQO',1,'https://starterdaily.com/upd/img/companies/negro_39767_full.png');
insert into company (id,name,number_of_computers,image_url) values ( 19,'NeXT',6,'https://upload.wikimedia.org/wikipedia/commons/thumb/3/30/NeXT_logo.svg/2000px-NeXT_logo.svg.png');    
insert into company (id,name,number_of_computers,image_url) values ( 20,'Atari',2,'https://vignette.wikia.nocookie.net/starwars/images/0/0e/Atari_logo.png/revision/latest?cb=20160127051924');
insert into company (id,name,number_of_computers,image_url) values ( 22,'Acorn computer',2,'https://www.retro-kit.co.uk/user/custom/collection/AcornComputers-Logo.jpg');
insert into company (id,name,number_of_computers,image_url) values ( 23,'Timex Sinclair',3,'https://botw-pd.s3.amazonaws.com/styles/logo-thumbnail/s3/0015/7891/brand.gif?itok=cz9OghAm');
insert into company (id,name,number_of_computers,image_url) values ( 24,'Nintendo',15,'https://vignette.wikia.nocookie.net/fantendo/images/f/fc/Nintendo-Logo.png/revision/latest?cb=20180130220004');
insert into company (id,name,number_of_computers,image_url) values ( 25,'Sinclair Research Ltd',9,'https://upload.wikimedia.org/wikipedia/commons/thumb/2/28/Sinclair.svg/2000px-Sinclair.svg.png');
insert into company (id,name,number_of_computers,image_url) values ( 26,'Xerox',0,'http://logok.org/wp-content/uploads/2015/03/Xerox-logo-880x660.png');
insert into company (id,name,number_of_computers,image_url) values ( 27,'Hewlett-Packard',5,'https://upload.wikimedia.org/wikipedia/commons/thumb/a/ad/HP_logo_2012.svg/2000px-HP_logo_2012.svg.png');
insert into company (id,name,number_of_computers,image_url) values ( 28,'Zemmix',1,'http://www.findthatlogo.com/wp-content/gallery/video-game-console-logos/zemmix-logo-1985.gif');
insert into company (id,name,number_of_computers,image_url) values ( 29,'ACVS',1,'http://www.norc.org/Announce/ACVS%20Logo_FINAL_color%20PMS072.png');
insert into company (id,name,number_of_computers,image_url) values ( 30,'Sanyo',1,'https://vignette.wikia.nocookie.net/logopedia/images/d/d1/Sanyo_logo.svg.png/revision/latest?cb=20120822010229');
insert into company (id,name,number_of_computers,image_url) values ( 31,'Cray',2,'https://pbs.twimg.com/profile_images/800378817/Untitled-7_400x400.gif');
insert into company (id,name,number_of_computers,image_url) values ( 32,'Evans & Sutherland',1,'https://i.vimeocdn.com/portrait/4459805_300x300');    
insert into company (id,name,number_of_computers,image_url) values ( 33,'E.S.R. Inc.',1,'http://www.infrabuddy.com/wp-content/uploads/2017/06/ESR-logo.png');
insert into company (id,name,number_of_computers,image_url) values ( 34,'OMRON',1,'https://upload.wikimedia.org/wikipedia/commons/thumb/6/6c/OMRON_Logo.svg/2000px-OMRON_Logo.svg.png');
insert into company (id,name,number_of_computers,image_url) values ( 35,'BBN Technologies',1,'https://www.zdnet.com/i/story/60/01/023636/bbntechnologies.png');
insert into company (id,name,number_of_computers,image_url) values ( 36,'Lenovo Group',4,'http://logonoid.com/images/lenovo-logo.png');
insert into company (id,name,number_of_computers,image_url) values ( 37,'ASUS',3,'https://seeklogo.com/images/A/asus-republic-of-gamers-logo-8B94B18AD7-seeklogo.com.png');
insert into company (id,name,number_of_computers,image_url) values ( 38,'Amstrad',7,'https://upload.wikimedia.org/wikipedia/commons/thumb/0/06/Amstrad_logo.svg/2000px-Amstrad_logo.svg.png');
insert into company (id,name,number_of_computers,image_url) values ( 39,'Sun Microsystems',2,'https://www.shareicon.net/download/2015/09/16/101915_sun.svg');
insert into company (id,name,number_of_computers,image_url) values ( 40,'Texas Instruments',1,'https://pbs.twimg.com/profile_images/522307074001088513/HavaFLKo_400x400.png');
insert into company (id,name,number_of_computers,image_url) values ( 41,'HTC Corporation',2,'http://1000logos.net/wp-content/uploads/2017/02/HTC-Logo.png');
insert into company (id,name,number_of_computers,image_url) values ( 42,'Research In Motion',2,'https://upload.wikimedia.org/wikipedia/fr/thumb/6/6d/Research_In_Motion_Logo.svg/1024px-Research_In_Motion_Logo.svg.png');
insert into company (id,name,number_of_computers,image_url) values ( 43,'Samsung Electronics',1,'http://pngimg.com/uploads/samsung_logo/samsung_logo_PNG3.png');
